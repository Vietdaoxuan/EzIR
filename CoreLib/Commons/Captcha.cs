...
namespace CoreLib.Commons
{
    public static class Captcha
    {
        ...
        public static bool ValidateCaptchaCode(string userInputCaptcha, HttpContext context)
        {
            try
            {
                if (string.IsNullOrEmpty(userInputCaptcha) || string.IsNullOrEmpty(context.Session.GetString(SessionTypes.CAPTCHA_CODE)))
                    return false;

                var isValid = userInputCaptcha == context.Session.GetString(SessionTypes.CAPTCHA_CODE);
                context.Session.Remove(SessionTypes.CAPTCHA_CODE);
